...
import { Box, Heading, Text, VStack, HStack, Badge, StackDivider } from "@chakra-ui/react";
      ...
      {user ? (
            <Box p={5}>
              <VStack spacing={5} align="start">
                ...
                <Box>
                  <Heading as="h2" size="md" mb={2}>Personal Information</Heading>
                  <Text><b>First Name:</b> {user?.firstName || "Not provided"}</Text>
                  <Text><b>Last Name:</b> {user?.lastName || "Not provided"}</Text>
                  <Text><b>Date of Birth:</b> {user?.dateOfBirth || "Not provided"}</Text>
                </Box>
        
                <Box>
                  <Heading as="h2" size="md" mb={2}>Addresses</Heading>
